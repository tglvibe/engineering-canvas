  ...
  return (
    <div>
      <div className="flex items-center gap-2 mb-3">
        ...
        <h3 className="text-sm font-semibold text-foreground">Blogs & Documentation</h3>
      ...
      <div className="space-y-2">
        {blogs.map(blog => (
          <a
            key={blog.id}
            href={blog.url}
            className="flex items-center justify-between p-3 rounded-lg border border-border bg-card hover:border-primary/30 hover:shadow-sm transition-all group"
          >
